...
function Nav() {
  ...
  useEffect(() => {
    fetch("http://auth.jaejun.me:10010/me", {
      ...
      headers: {
        Authorization:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjo0NiwiaWF0IjoxNjYxMjI2NjExLCJleHAiOjE2NjM5MDUwMTF9.X_OvYFqndX7RQomOl0Xn4qy4RX28s2kvkPXWhsKo_Uc",
      },
    })
      .then((res) => res.json())
      .then((data) =>
  ...
  return (
    <header className="headerWrap">
      ...
      <div className="v-center">
        <input
          className="headerSearch paddingLeft"
          type="search"
          placeholder="검색"
        />
      </div>
